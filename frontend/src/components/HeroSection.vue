  ...
  <div class="relative overflow-hidden bg-white z-0">
      ...
      >
        ...
        >
          <div class="sm:text-center lg:text-left">
            ...
            >
              <span class="block xl:inline">Buy smart, love it</span>
              {{ " " }}
              <span class="block text-green-600 xl:inline">keep it</span>
            </h1>
            <p
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img
        ...
        src="https://images.unsplash.com/photo-1559037068-e98af2a7c244?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1332&q=80"
        alt=""
      />
    </div>
  </div>
